...
echo 'add a remote pseudo for the open-30-no-abstract repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/open-30-no-abstract
